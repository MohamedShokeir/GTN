...
inline std::vector<double> scalarNewtonSolver(std::function<double (double&, const std::vector<double>&)> f, std::function<double (double&, const std::vector<double>&)> df, const std::vector<double>& param, const double& x1){
